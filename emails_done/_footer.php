...
<img src="https://assets.meska.hu/images/logo/logo.svg" class="logo" style="width: 20%; margin: 2% auto 0 auto; display: block;">
...
<div class="grey-bg" style="background-color: #eeeeee;">
    ...
    <div class="container footer" style="margin: 0 2% 0 2%; color: #888888; font-size: 0.75em; line-height: 1.5em;">
        <p style="text-align: center; color: #555555; line-height: 1.5em; font-size: 1.3em;">
            Ezt az e-mailt az <?=Emails::$_email?> címre küldtük ki, mert a vásárlási folyamat félbeszakadt és erre figyelmeztetni szerettünk volna.
        </p>
        <p style="text-align: center; color: #555555; line-height: 1.5em; font-size: 1.3em;">
            2008-<?=Emails::$_year?> &copy; Meska.hu Kft - Minden jog fenntartva.
        </p>
    </div>
    <br><br>
</div>
