...
<div class="wrapper" style="background-color: #ffffff; border: 1px solid #dddddd; border-radius: 0.5vw; width: 99%; margin: 0 auto 0 auto;">
    <img src="https://assets.meska.hu/images/logo/logo.svg" class="logo" style="width: 200px; margin: 1%  auto 0 auto; display: block;"><div class="breaker thick green" style="width: 100%; height: 0px; border-color: #006600; border-style: solid; border-top-width: 1px; border-left: none; border-right: none; border-bottom: none; margin: 2% 0 2% 0; border-width: 0.3vw;"> </div>
