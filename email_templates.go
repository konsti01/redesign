...
<div class="wrapper" style="background-color: #ffffff; border: 1px solid #dddddd; border-radius: 0.5vw; width: 99%; margin: 0 auto 0 auto;">
    ...
    <div class="container" style="margin: 0 2% 0 2%;">
                ...
                <td>
                    <table class="product-table" style="width: 100%; border-spacing: 0; border-collapse: collapse; color: #555555;">
                        ...
                        <tr>
                            ...
                            <td class="unit-price" style="border: 1px solid #dddddd; text-align: right; margin: 0; padding: 1.5%; font-size: 1.2em;">
                                {{.price}}.- Ft
                            </td>
                            ...
                            <td class="sum" style="border: 1px solid #dddddd; text-align: right; margin: 0; padding: 1.5%; font-size: 1.2em; font-weight: bold; color: #006600;">
                                {{.price}}.- Ft
                            </td>
                        </tr>
                        {{end}}
        ...
        <center>
            <a href="http://www.meska.hu/Basket" class="btn" style="text-decoration: none; cursor: pointer; color: #ffffff !important; display: block; padding: 1% 2%; margin: 1% 0 1% auto; width: 35%; background-color: #88B04B; border-radius: 0.3vw; text-align: center; font-size: 1em;">Vásárlás&nbsp;folytatása&nbsp;»</a>
        </center>
    </div>
    ...
    <div>
        <a href="http://www.meska.hu/Basket" class="btn" style="text-decoration: none;cursor: pointer;color: #ffffff !important;display: block;padding: 2% 4%;margin: 1% auto 1% auto;width: 40%;background-color: #88B04B;border-radius: 0.3vw;text-align: center;font-size: 1.5em;">Vásárlás&nbsp;folytatása&nbsp;»</a>    </div>
