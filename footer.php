...
<script type="text/javascript">
    $(function () {
        ...
        var pdp = $('.post-details-popover').popover({
            ...
            html: true,
            content: '<i class="fa fa-times pull-right cursor-pointer" aria-hidden="true"></i><div>Az eladó nem adta meg a szállítási információkat. Kérjük egyeztess vele a vásárlást követően!</div>'
        });
        ...
        $('.barion-details-popover').popover({
            ...
            placement: 'bottom',
            html: true,
            content: '<i class="fa fa-times pull-right cursor-pointer" aria-hidden="true"></i>Bankkártyával is fizethető'
        });
        $('.giftcard-details-popover').popover({
            trigger: 'focus hover',
            placement: 'bottom',
            html: true,
            content: '<i class="fa fa-times pull-right cursor-pointer"></i>Ajándékkártyával is fizethető'
        });
        ...
        jQuery("#quick-search-input").on("keyup", function(event){
            ...
            if(value !== ""){
                ...
                jQuery("#search-suggestion .fav-link").attr("href", "/find?q="+value+"&favourites=milanteszt");
...
<script src="https://www.meska.hu/bootstrap/lightbox/js/lightbox.min.js"></script>
<script>
    lightbox.option({
        'albumLabel': '%1 / %2'
    })
